...
<html>
  ...
  <body style="margin: 50px 0px 0px 0px">
            ...
            <ul class="navbar-nav flex-grow-1 justify-content-between">
              <li class="nav-item d-none d-xs-block d-md-block">
                <a class="nav-link" href="#"
                  ><i class="fa fa-mortar-board apple-logo"></i>&nbsp; Instituto
                  Superior "Manuel Leiva"</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Alumnado</a>
              </li>
              <li class="nav-item">
    ...
    <div class="row" style="height: 40px; background: rgba(249, 185, 88, 0.91)">
      ...
      <div
        class="col d-xl-flex justify-content-xl-center align-items-xl-center"
        style="height: 140px; background: rgba(86, 80, 80, 0.72)"
      >
        <img
          class="img-fluid"
          src="assets/img/LogoLeiva.png"
          style="width: 120px"
        />
      </div>
      <div
        ...
        style="height: 40px"
      >
        <a class="text-dark miLink" data-bss-hover-animate="pulse" href="#"
          >Normativa</a
        >
      </div>
      <div
